...
export const getHexSrc = (base64Png) => {
  ...
  <g clip-path="url(#clip-shape-img)">
  <image href="${base64Png}" y="3" height="120" width="120" preserveAspectRatio="xMidYMid slice" />
</g>
