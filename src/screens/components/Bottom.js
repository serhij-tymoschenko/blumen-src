...
const Bottom = () => {
    return (
        <Stack
            ...
            width={'100vw'}
        >
            <Link href="https://github.com/serhij-tymoschenko/blumen-src" target="_blank" rel="noopener" justifySelf={"flex-start"}>
                <svg height="51" aria-hidden="true" viewBox="0 0 24 24" width="51">
                    <path
            ...
            <Link href="https://buymeacoffee.com/tymoschenko" target="_blank" rel="noopener" justifySelf={"flex-end"}>
